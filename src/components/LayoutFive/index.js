...
import layoutFiveActive from "../../assets/img/5s.png";
...
class LayoutFive extends Component {
    constructor(props) {
        super(props);
    ...
    state = {
        ...
        imageTwoXPos: 50,
        imageTwoYPos: 50,
        // image 3 focusing variable
        imageThreeCurrentX: 0,
        imageThreeCurrentY: 0,
        imageThreeXPos: 50,
        imageThreeYPos: 50,
    };
    focus = () => {
    ...
    onChangePageTextHandler = (event, payload) => {
        ...
        // let final_string = alignText(event.target.value, 68);
    ...
    componentWillMount() {
        ...
        this.setState({
            ...
            // image3 state
            imageThreeCurrentX: this.props.page.image3.currentX,
            imageThreeCurrentY: this.props.page.image3.currentY,
            imageThreeXPos: this.props.page.image3.left,
            imageThreeYPos: this.props.page.image3.top
        })
    }
    ...
    // ********************************** Image3 image focusing logic **********************************
    _moveThree = (currentX, currentY, xPos, yPos) => {
        if (this.state.active) {
            repositionImage({page_index: this.props.page_index, currentX, currentY, xPos, yPos, image_no: 'image3'});
            this.setState({
                imageThreeCurrentX: currentX,
                imageThreeCurrentY: currentY,
                imageThreeXPos: xPos,
                imageThreeYPos: yPos
            });
        }
    ...
    render() {
        ...
        if (path === '/pdf') {
            ...
            selected_image3 = IMAGE_SERVER_URL + page.image3.file_reference;
        } else {
            if (page_no === 'Zoom') {
                ...
                selected_image3 = page.image3.resolutions.findIndex(r => r === 1600) > -1 ? IMAGE_SERVER_URL + page.image3.file_reference + '1600' : IMAGE_SERVER_URL + page.image3.file_reference;
                ...
                selected_image3 = page.image3.resolutions.findIndex(r => r === 200) > -1 ? IMAGE_SERVER_URL + page.image3.file_reference + '200' : IMAGE_SERVER_URL + page.image3.file_reference;
        ...
        return (
            <Fragment>
                <h4 className="page_title">
                    ...
                    <div className="top">
                        ...
                        <input type="image" src={layout4}
                               ...
                               alt='some label'
                        />
                        <input type="image" src={layoutFiveActive} className="img-input" alt='some label'
                        />
                ...
                <div className="layout5">
                    <div className="layout5-input-container"
                         onClick={(event) => this.textAreaClick(event, {page_index, zoomPage, title})}>
                        <textarea className={page_no === 'Zoom' ? "layout5-zoom-input" : "layout5-input"}
                    ...
                    <div className="layout5-image-container">
                        <div className="layout5-one-image-container">
                            {page.image1.file_id !== '' && (
                                <div
                                    className={'img-container ' + (page_no === 'Zoom' ? "layout5-zoom-one-image-container-image" : "layout5-one-image-container-image")}
                                    ...
                                    <Draggable
                                        ...
                                        <div className='btn-reposition-image'
                                            ...
                                            <button className='btn-arrow-left'><FontAwesomeIcon icon='angle-left'/>
                                            </button>
                                            ...
                                            <button className='btn-arrow-down'><FontAwesomeIcon icon='angle-down'/>
                                            </button>
                                        </div>
                                    </Draggable>}
                                </div>
                            ...
                            <PageFileUploader page={page} page_index={page_index} image='image1' title={title}
                                              className={page_no === 'Zoom' ? 'layout5-zoom-image1-uploader' : 'layout5-image1-uploader'}/>}
                        </div>
                        <div className="layout5-two-image-container">
                            <div className="layout5-two-image-container1">
                                {page.image2.file_id !== '' && (
                                    <div
                                        className={'img-container ' + (page_no === 'Zoom' ? "layout5-zoom-two-image-container1-image" : "layout5-two-image-container1-image")}
                                        draggable={this.state.draggable}
                                        onDragStart={(e) => this.onDragStart(e, {
                                        ...
                                        <Draggable
                                            ...
                                            <div className='btn-reposition-image'
                                                ...
                                                <button className='btn-arrow-right'><FontAwesomeIcon
                                                    icon='angle-right'/>
                                                </button>
                                                <button className='btn-center-image'>
                                                    {/*    Center Image*/}
                                                </button>
                                                <button className='btn-arrow-up'><FontAwesomeIcon icon='angle-up'/>
                                                </button>
                                                <button className='btn-arrow-down'><FontAwesomeIcon icon='angle-down'/>
                                                </button>
                                            </div>
                                ...
                                <PageFileUploader page={page} page_index={page_index} image='image2' title={title}
                                                  className={page_no === 'Zoom' ? 'layout5-zoom-image2-uploader' : 'layout5-image2-uploader'}/>}
                            </div>
                            <div className="layout5-two-image-container2">
                                {page.image3.file_id !== '' && (
                                    <div
                                        className={'img-container ' + (page_no === 'Zoom' ? "layout5-zoom-two-image-container2-image" : "layout5-two-image-container2-image")}
                                        draggable={this.state.draggable}
                                        onDragStart={(e) => this.onDragStart(e, {
                                            file_id: page.image3.file_id,
                                            from_page: page_index,
                                            from_image: 'image3'
                                        })}
                                        onDrop={(event) => this.onDropImageHandler(event, {
                                        ...
                                        id={page.image3.file_id}
                                        style={{
                                            background: `url(${selected_image3}) ${this.state.imageThreeXPos}% ${this.state.imageThreeYPos}% / cover no-repeat`,
                                        }}
                                        onMouseEnter={() => this.setState({showImage3Buttons: true})}
                                        onMouseLeave={() => this.setState({
                                            showImage3Buttons: false,
                                            active: false,
                                            draggable: true
                                        })}
                                        onTouchStart={() => this.setState({showImage3Buttons: true})}
                                        onTouchEnd={() => this.setState({showImage3Buttons: false})}>
                                        <button type='button'
                                                className={'btn-remove-img-from-page ' + (this.state.showImage3Buttons ? '' : 'display-none')}
                                                onClick={() => onRemoveImageFromPage({
                                                    image_no: 'image3',
                                                    file_id: page.image3.file_id,
                                                    page_index: page_index,
                                        ...
                                        {/*object-position: 10% 10%; first 10% is for left and right positioning. and another 10% is for top and bottom positioning*/}
                                        {/*when click on btn-arrow-up button then value will increase up to 100%. when click on btn-arrow-down button then value will decrease up to 0 */}
                                        {this.state.showImage3Buttons &&
                                        <Draggable
                                            x={this.state.imageThreeCurrentX}
                                            y={this.state.imageThreeCurrentY}
                                            xPos={this.state.imageThreeXPos}
                                            yPos={this.state.imageThreeYPos}
                                            xPosSum={41}
                                            yPosSum={-17}
                                            xMul={1.3}
                                            yMul={3}
                                ...
                                {page.image3.file_id === '' &&
                                <PageFileUploader page={page} page_index={page_index} image='image3' title={title}
                                                  className={page_no === 'Zoom' ? 'layout5-zoom-image3-uploader' : 'layout5-image3-uploader'}/>}
                            </div>
                        </div>
                    </div>
                </div>
...
const LayoutFiveContainer = connect(
    mapStateToProps,
    mapDispatchToProps
)(LayoutFive);

export default LayoutFiveContainer;
