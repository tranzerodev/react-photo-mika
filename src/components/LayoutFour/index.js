...
class LayoutFour extends Component {
    constructor(props) {
        super(props);
    ...
    onChangePageTextHandler = (event, payload) => {
        ...
        // let final_string = alignText(event.target.value, 22);
                ...
                <div className="layout4">
                    ...
                    <div className="layout4-image-container">
                        <div className="layout4-one-image-container">
                            {page.image1.file_id !== '' && (
                                <div
                                    className={'img-container ' + (page_no === 'Zoom' ? "layout4-zoom-one-image-container-image" : "layout4-one-image-container-image")}
                            ...
                            <PageFileUploader page={page} page_index={page_index} image='image1' title={title}
                                              className={page_no === 'Zoom' ? 'layout4-zoom-image1-uploader' : 'layout4-image1-uploader'}/>}
                        </div>
                        <div className="layout4-two-image-container">
                            <div className="layout4-two-image-container1">
                                {page.image2.file_id !== '' && (
                                    <div
                                        className={'img-container ' + (page_no === 'Zoom' ? "layout4-zoom-two-image-container1-image" : "layout4-two-image-container1-image")}
                                        draggable={this.state.draggable}
                                        onDragStart={(e) => this.onDragStart(e, {
                                ...
                                <PageFileUploader page={page} page_index={page_index} image='image2' title={title}
                                                  className={page_no === 'Zoom' ? 'layout4-zoom-image2-uploader' : 'layout4-image2-uploader'}/>}
                            </div>
                            <div className="layout4-two-image-container2">
                                {page.image3.file_id !== '' && (
                                    <div
                                        className={'img-container ' + (page_no === 'Zoom' ? "layout4-zoom-two-image-container2-image" : "layout4-two-image-container2-image")}
                                        draggable={this.state.draggable}
                                        onDragStart={(e) => this.onDragStart(e, {
                                ...
                                <PageFileUploader page={page} page_index={page_index} image='image3' title={title}
                                                  className={page_no === 'Zoom' ? 'layout4-zoom-image3-uploader' : 'layout4-image3-uploader'}/>}
                            </div>
                        </div>
                    </div>
                    <div className="layout4-input-container"
                         onClick={(event) => this.textAreaClick(event, {page_index, zoomPage, title})}>
                        <textarea className={page_no === 'Zoom' ? "layout4-zoom-input" : "layout4-input"}
